...
<head>
    ...
    <title>Salad Restaurant Mobile App</title>
    <style>
        /* CSS Reset */
        body, h1, h2, p, img {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.6;
            color: #2c3e50;
            background: linear-gradient(135deg, #f3ffe2, #a8e063);
            padding: 20px;
        }
...
alt="Salad Bowl">
        ...
        <footer>
<p>© 2024, Mario Silva. This is a fictitious web page created solely for the purpose of education and training. All products and people associated with this web page are fictitious. Any resemblance to real brands, products, or people is purely coincidental. Information provided about the product is also fictitious and should not be construed to be representative of actual products on the market in a similar product category.</p>
